...
- [ux-ai-first.md](product/ux-ai-first.md) — chat-first UX, workspaces, monitoring agents
...
- [overview.md](architecture/overview.md) — components and flows
- [edge-vs-server.md](architecture/edge-vs-server.md) — responsibility split
- [axis-vapix.md](architecture/axis-vapix.md) — Axis integration design
